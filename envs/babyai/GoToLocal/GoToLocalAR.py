...
class GoToLocalAR(GoToLocal):
    def __init__(self, tile_size=8, seeds=[0], objcolor="grey", objtype="box",seed_idx=0,**kwargs):
    ...
    def gen_mission(self):
        ...
        self.instrs = GoToInstr(ObjDesc(self.objtype, self.objcolor))
